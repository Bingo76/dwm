...
static const char *mutevolcmd[] = { "pamixer", "--mute",  NULL };
static const char *unmutevolcmd[] = {"pamixer", "--unmute", NULL };
...
static const Key keys[] = {
  ...
  // Volume
	{ MODKEY,                       XK_F1,     spawn,          {.v = downvolcmd } },
	{ MODKEY,                       XK_F2,     spawn,          {.v = upvolcmd } },
	{ MODKEY,                       XK_F3,     spawn,          {.v = mutevolcmd } },
	{ MODKEY|ShiftMask,             XK_F3,     spawn,          {.v = unmutevolcmd } },
  // Screenshot
